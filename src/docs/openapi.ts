...
export const openApiDocument = {
  ...
  tags: [{ name: "Health" }, { name: "Staff Auth" }, { name: "Appointment Drafts" }, { name: "Appointment Requests" }, { name: "New Patient Requests" }, { name: "Files" }],
  paths: {
