...
const newPatientBaseResponse = {
  type: "object",
  required: ["id", "ownerFullName", "ownerEmail", "ownerPhoneNumber", "petName", "species", "breed", "age", "sex", "weightLbs", "spayedNeutered", "currentMedications", "existingConditions", "reasonForVisit", "isUrgent", "preferredDateTime", "timezone", "previousVetClinic", "consentToElectronicComms", "referralSource", "referralSourceOther", "referralSourceCapturedAt", "ownerId", "petId", "possibleDuplicate", "duplicateOfId", "files", "createdAt", "updatedAt"],
  properties: {
    id: { type: "string" }, ownerFullName: { type: "string" }, ownerEmail: { type: "string", nullable: true }, ownerPhoneNumber: { type: "string" }, petName: { type: "string" }, species: { $ref: "#/components/schemas/PetSpecies" }, breed: { type: "string", nullable: true }, age: { type: "string", nullable: true }, sex: { $ref: "#/components/schemas/PetSex" }, weightLbs: { type: "string", nullable: true }, spayedNeutered: { type: "boolean", nullable: true }, currentMedications: { type: "string", nullable: true }, existingConditions: { type: "string", nullable: true }, reasonForVisit: { type: "string" }, isUrgent: { type: "boolean" }, preferredDateTime: { type: "string", format: "date-time", nullable: true }, timezone: { type: "string", nullable: true }, previousVetClinic: { type: "string", nullable: true }, consentToElectronicComms: { type: "boolean" }, referralSource: { $ref: "#/components/schemas/NewPatientReferralSource", nullable: true }, referralSourceOther: { type: "string", nullable: true }, referralSourceCapturedAt: { type: "string", format: "date-time", nullable: true }, ownerId: { type: "string", nullable: true }, petId: { type: "string", nullable: true }, possibleDuplicate: { type: "boolean" }, duplicateOfId: { type: "string", nullable: true }, files: { type: "array", items: { $ref: "#/components/schemas/UploadedFileDto" } }, createdAt: { type: "string", format: "date-time" }, updatedAt: { type: "string", format: "date-time" }
  }
} as const;

const newPatientCreateResponse = {
  ...newPatientBaseResponse,
  required: [...newPatientBaseResponse.required, "referralSourceCaptureToken"],
  properties: {
    ...newPatientBaseResponse.properties,
    referralSourceCaptureToken: { type: "string", minLength: 64, maxLength: 64 }
  }
} as const;

const newPatientDetailResponse = {
  ...newPatientBaseResponse
} as const;
...
export const openApiDocument = {
  ...
  tags: [{ name: "Health" }, { name: "Staff Auth" }, { name: "Admin Wellness Plans" }, { name: "Appointment Drafts" }, { name: "Appointment Requests" }, { name: "New Patient Requests" }, { name: "Pet Care" }, { name: "Files" }],
  paths: {
    ...
    "/api/appointment-requests/mark-overdue": { post: { tags: ["Appointment Requests"], security: [{ bearerAuth: [] }], responses: { "200": jsonResponse("Overdue sweep completed", { $ref: "#/components/schemas/AppointmentOverdueSweepResponse" }), "401": { $ref: "#/components/responses/Unauthorized" }, "403": { $ref: "#/components/responses/Forbidden" }, "500": { $ref: "#/components/responses/InternalServerError" } } } },
    ...
    "/api/new-patient-requests": { post: { tags: ["New Patient Requests"], requestBody: { $ref: "#/components/requestBodies/NewPatientCreateRequest" }, responses: { "201": jsonResponse("New-patient request created", { $ref: "#/components/schemas/NewPatientCreateResponse" }), "400": { $ref: "#/components/responses/BadRequest" }, "404": { $ref: "#/components/responses/NotFound" }, "409": { $ref: "#/components/responses/Conflict" }, "500": { $ref: "#/components/responses/InternalServerError" } } }, get: { tags: ["New Patient Requests"], security: [{ bearerAuth: [] }], parameters: [{ $ref: "#/components/parameters/SearchQueryParam" }, { $ref: "#/components/parameters/DateFromQueryParam" }, { $ref: "#/components/parameters/DateToQueryParam" }, { $ref: "#/components/parameters/LimitQueryParam" }, { $ref: "#/components/parameters/CursorQueryParam" }, { $ref: "#/components/parameters/NewPatientReferralSourceQueryParam" }], responses: { "200": jsonResponse("New-patient request list", { $ref: "#/components/schemas/NewPatientListResponse" }), "400": { $ref: "#/components/responses/BadRequest" }, "401": { $ref: "#/components/responses/Unauthorized" }, "403": { $ref: "#/components/responses/Forbidden" }, "500": { $ref: "#/components/responses/InternalServerError" } } } },
    "/api/new-patient-requests/{id}/referral-source": { post: { tags: ["New Patient Requests"], parameters: [{ $ref: "#/components/parameters/IdPathParam" }], requestBody: { $ref: "#/components/requestBodies/NewPatientReferralSourceRequest" }, responses: { "200": jsonResponse("Referral source captured", { $ref: "#/components/schemas/NewPatientDetailResponse" }), "400": { $ref: "#/components/responses/BadRequest" }, "404": { $ref: "#/components/responses/NotFound" }, "409": { $ref: "#/components/responses/Conflict" }, "410": { $ref: "#/components/responses/Gone" }, "500": { $ref: "#/components/responses/InternalServerError" } } } },
    ...
    "/api/pet-care/newsletter-subscriptions": { post: { tags: ["Pet Care"], summary: "Create a Brevo double-opt-in newsletter confirmation request", requestBody: { $ref: "#/components/requestBodies/PetCareNewsletterSubscriptionRequest" }, responses: { "202": jsonResponse("Double opt-in confirmation email requested", { $ref: "#/components/schemas/PetCareNewsletterSubscriptionResponse" }), "400": { $ref: "#/components/responses/BadRequest" }, "429": { $ref: "#/components/responses/TooManyRequests" }, "503": { $ref: "#/components/responses/ServiceUnavailable" }, "500": { $ref: "#/components/responses/InternalServerError" } } } },
  ...
  components: {
    responses: {
      BadRequest: simpleErrorResponse("Bad request"), Unauthorized: simpleErrorResponse("Unauthorized"), Forbidden: simpleErrorResponse("Forbidden"), NotFound: simpleErrorResponse("Not found"), Conflict: simpleErrorResponse("Conflict"), Gone: simpleErrorResponse("Expired resource"), TooManyRequests: simpleErrorResponse("Too many requests"), ServiceUnavailable: simpleErrorResponse("Service unavailable"), PayloadTooLarge: simpleErrorResponse("Payload too large"), UnsupportedMediaType: simpleErrorResponse("Unsupported media type"), InternalServerError: simpleErrorResponse("Internal server error")
    },
    securitySchemes: {
    ...
    parameters: {
      ...
      NewPatientReferralSourceQueryParam: { name: "referralSource", in: "query", required: false, schema: { anyOf: [{ $ref: "#/components/schemas/NewPatientReferralSource" }, { type: "string", enum: ["NOT_CAPTURED"] }] } },
    ...
    schemas: {
      ...
      NewPatientReferralSourceRequest: { type: "object", required: ["token", "source"], additionalProperties: false, properties: { token: { type: "string", minLength: 64, maxLength: 64 }, source: { $ref: "#/components/schemas/NewPatientReferralSource" }, otherText: { type: "string", maxLength: 200 } } },
      PetCareNewsletterPetPreference: { type: "string", enum: ["DOG", "CAT", "BOTH"] },
      PetCareNewsletterSubscriptionRequest: { type: "object", required: ["email", "petPreference", "consent"], additionalProperties: false, properties: { email: { type: "string", format: "email", maxLength: 254 }, petPreference: { $ref: "#/components/schemas/PetCareNewsletterPetPreference" }, consent: { type: "boolean", enum: [true] }, source: { type: "string", enum: ["pet-care-library"], default: "pet-care-library" }, website: { type: "string", maxLength: 200, description: "Honeypot field. Leave empty." } } },
      PetCareNewsletterSubscriptionResponse: { type: "object", required: ["success", "status", "message"], properties: { success: { type: "boolean", enum: [true] }, status: { type: "string", enum: ["confirmation_required"] }, message: { type: "string", example: "Please check your email to confirm your subscription." } } },
      ...
      AppointmentRequestDetailResponse: appointmentRequestDetailResponse, AppointmentStatusUpdateResponse: { type: "object", required: ["id", "status", "updatedAt"], properties: { id: { type: "string" }, status: { $ref: "#/components/schemas/AppointmentRequestStatus" }, updatedAt: { type: "string", format: "date-time" } } }, AppointmentOverdueSweepResponse: { type: "object", required: ["markedCount"], properties: { markedCount: { type: "integer", minimum: 0 } } },
      ...
      NewPatientListResponse: { type: "object", required: ["data", "nextCursor"], properties: { data: { type: "array", items: { type: "object", required: ["id", "ownerFullName", "ownerEmail", "ownerPhoneNumber", "petName", "species", "reasonForVisit", "isUrgent", "preferredDateTime", "timezone", "referralSource", "referralSourceOther", "referralSourceCapturedAt", "possibleDuplicate", "duplicateOfId", "ownerId", "petId", "createdAt", "updatedAt"], properties: { id: { type: "string" }, ownerFullName: { type: "string" }, ownerEmail: { type: "string", nullable: true }, ownerPhoneNumber: { type: "string" }, petName: { type: "string" }, species: { $ref: "#/components/schemas/PetSpecies" }, reasonForVisit: { type: "string" }, isUrgent: { type: "boolean" }, preferredDateTime: { type: "string", format: "date-time", nullable: true }, timezone: { type: "string", nullable: true }, referralSource: { $ref: "#/components/schemas/NewPatientReferralSource", nullable: true }, referralSourceOther: { type: "string", nullable: true }, referralSourceCapturedAt: { type: "string", format: "date-time", nullable: true }, possibleDuplicate: { type: "boolean" }, duplicateOfId: { type: "string", nullable: true }, ownerId: { type: "string", nullable: true }, petId: { type: "string", nullable: true }, createdAt: { type: "string", format: "date-time" }, updatedAt: { type: "string", format: "date-time" } } } }, nextCursor: { type: "string", nullable: true } } },
      NewPatientDetailResponse: newPatientDetailResponse, FilesUploadedResponse: { type: "object", required: ["files"], properties: { files: { type: "array", items: { $ref: "#/components/schemas/UploadedFileDto" } } } }
    }
  }
} as const;
